...
The Swift server listens on `0.0.0.0:3768`, preserves the existing HTTP routes,
and opens Conductor's SQLite database read-only with `query_only` enabled. The
